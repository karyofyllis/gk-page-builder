...
export const componentList = [
  new Component(
    ...
    'Title',
    <Title />,
    (props) => <Paragraph variant='h3' {...props} placeholder='Enter title' />,
    headingProps
  ),
  new Component(
    'paragraph',
  ...
  new Component('simpleGrid', 'Simple Grid', <ViewColumn />, (props) => (
    <SimpleGrid {...props} />
  )),
  new Component('image', 'Image', <Image />, (props) => (
    <ImageView {...props} />
  )),
  new Component('mediaAndText', 'Media and Text', <ArtTrack />, (props) => (
    <MediaAndText {...props} />
  )),
  new Component(
    'richText',
  ...
  new Component('list', 'List', <List />, (props) => <BlockList {...props} />, {
    items: ['']
  }),
  new Component(
    'button',
  ...
  new Component('divider', 'Divider', <Minimize />, (props) => (
    <Divider {...props} />
  )),
